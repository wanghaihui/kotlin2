...
Java_com_imagine_ffmpeg_FFmpegNative_innerRunCommand(JNIEnv *env, jclass type, jobjectArray command) {
...
Java_com_imagine_ffmpeg_FFmpegNative_setDebug(JNIEnv *env, jclass type, jboolean debug) {
